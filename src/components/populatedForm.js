...
class PopulatedForm extends Component {
    ...
    render() {
        return ( this.state.tarefaPrePopulada.tarefa !== "" ? <TarefaForm onSubmit = {(formData) => this.onSubmit(formData)} tarefaPrePopulada={this.state.tarefaPrePopulada}/>: (<h1>carregando</h1>)
